...
(function() {
    ...
    /**
     * Restores the previous itr variable
     * @return {Object} this reference
     */
    itr.noConflict = function() {
       root.itr = previousItr;
       return this;
    };
     ...
     */
    itr.count = function(start, end, step, fn, context) {
        var i;
     ...
     * @param  {*}        context  Optional context to call the function in
     */
    itr.cycle = function(arr, n, fn, context) {
        var length = arr.length;
        var i = 0;
     ...
     * @param  {*}        context   Optional context to call the function in
     */
    itr.distinct = function(arr, fn, context) {
     ...
     * @param  {*}        context  Optional context to call the function in
     */
    itr.cartesianProduct = function(arrA, arrB, fn, context) {
        var i, j;
     ...
     */
    itr.groupBy = function(arr, fn, context) {
        var i;
        var length = arr.length;
        var ret = [];
        var current = null;
     ...
     */
    itr.imap = function(fn, context, arrs) {
     ...
     */
    itr.iterate = function(x, num, fn, context) {
        var i;
        var ret = [];
     ...
     */
    itr.slices = function(arr, n, fn, context) {
        var i;
     ...
     */
    itr.subsets = function(arr, fn, context, n) {
        var uniques = [];
     ...
     * @param  {*}        context    Optional context to call the function in
     */
    itr.takeNth = function(arr, n, fn, context) {
        var length = arr.length;
        var i;
     ...
     */
    itr.takeStrict = function(arr, n, reversed) {
        var length = arr.length;
     ...
     * @param  {*}        context  Optional context to call the function in
     */
    itr.times = function(n, fn, context, step) {
